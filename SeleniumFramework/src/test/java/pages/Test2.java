//Clicking on the letter  A B C D and then click on the product list page
package pages;
...
public class Test2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://www.espares.co.uk/search/pt1590/cooker-hoods/buttons-and-switches?vwo_opt_out=1");
		Thread.sleep(8000);
